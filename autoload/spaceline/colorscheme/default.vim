...
" License: MIT License
" =============================================================================
function! spaceline#colorscheme#default#default()
  let s:slc={}
  ...
  if g:seperate_style  == 'slant'
      call spaceline#colors#spaceline_hl('HomeMode', s:slc, 'gray', 'purple')
      if empty(expand('%t'))
        call spaceline#colors#spaceline_hl('HomeModeRight',s:slc,  'purple', 'gray')
      else
        call spaceline#colors#spaceline_hl('HomeModeRight',s:slc,  'purple', 'green')
      endif
      call spaceline#colors#spaceline_hl('FileNameRight',s:slc, 'blue','green')
      call spaceline#colors#spaceline_hl('FileSizeRight',s:slc, 'green','gray')
      call spaceline#colors#spaceline_hl('GitLeft',s:slc,  'gray',  'blue')
      call spaceline#colors#spaceline_hl('GitRight',s:slc,  'darknavy',  'blue')
  ...
  elseif g:seperate_style == 'slant-cons'
    call spaceline#colors#spaceline_hl('HomeMode', s:slc, 'gray', 'purple')
    call spaceline#colors#spaceline_hl('HomeModeRight',s:slc,  'purple', 'green')
    call spaceline#colors#spaceline_hl('FileNameRight',s:slc, 'green','blue')
    call spaceline#colors#spaceline_hl('FileSizeRight',s:slc, 'green','gray')
    call spaceline#colors#spaceline_hl('GitLeft',s:slc,  'gray',  'blue')
    call spaceline#colors#spaceline_hl('GitRight',s:slc,  'blue',  'darknavy')
  ...
  elseif g:seperate_style  == 'slant-fade'
    ...
    call spaceline#colors#spaceline_hl('FileNameRight',s:slc, 'blue','green')
    call spaceline#colors#spaceline_hl('FileSizeRight',s:slc, 'green','gray')
    call spaceline#colors#spaceline_hl('GitLeft',s:slc,  'red',  'blue')
    call spaceline#colors#spaceline_hl('GitRight',s:slc,  'red','darknavy')
    call spaceline#colors#spaceline_hl('InActiveHomeRight', s:slc, 'gray', 'gray')
    call spaceline#colors#spaceline_hl('ShortRight', s:slc, 'gray', 'darknavy')
  elseif g:seperate_style == 'arrow-fade'
    ...
    call spaceline#colors#spaceline_hl('FileNameRight',s:slc, 'green','blue')
    call spaceline#colors#spaceline_hl('FileSizeRight',s:slc, 'green','gray')
    call spaceline#colors#spaceline_hl('GitLeft',s:slc,  'blue',  'blue')
    call spaceline#colors#spaceline_hl('GitRight',s:slc,  'blue',  'darknavy')
    call spaceline#colors#spaceline_hl('InActiveHomeRight', s:slc, 'gray', 'gray')
    call spaceline#colors#spaceline_hl('ShortRight', s:slc, 'gray', 'darknavy')
  elseif g:seperate_style  == 'curve'
    ...
    call spaceline#colors#spaceline_hl('FileSizeRight',s:slc, 'gray','green')
    call spaceline#colors#spaceline_hl('GitLeft',s:slc,  'gray',  'blue')
    call spaceline#colors#spaceline_hl('GitRight',s:slc,  'gray',  'blue')
  ...
  call spaceline#colors#spaceline_hl('CocWarn',s:slc,  'yellow',  'darknavy')
  call spaceline#colors#spaceline_hl('CocOK',s:slc,  'green',  'darknavy')

  call spaceline#colors#spaceline_hl('GitBranchIcon', s:slc, 'red',  'blue')
  call spaceline#colors#spaceline_hl('GitInfo',s:slc,  'lightgray',  'blue')
  call spaceline#colors#spaceline_hl('GitAdd',s:slc,  'green',  'blue') " purple ok
  call spaceline#colors#spaceline_hl('GitRemove',s:slc,  'red',  'blue')
  call spaceline#colors#spaceline_hl('GitModified',s:slc,  'yellow',  'blue')
